...
//		Date d = fmtStrToDate("2021-06-04 19:37:09");
//		Date a = new Date(System.currentTimeMillis());
//		System.out.println(a);
//		System.out.println(format(a));

//		// 开卡时间
//		Date d1 = DateUtil.format("2021-06-15 19:27:25");
//		// 当前时间
//
//		Date d2 = DateUtil.addMonth(DateUtil.format("2021-06-17 19:27:25"), +1);
...
//		}
//
//		String s = DateUtil.getSecondInterval(d2, d1);
//		System.out.println(s);
	 ...
	 * @return 日期字符串
	 */
	public static String getSecondInterval(Date oriD, Date nowD) {
		long oridl = oriD.getTime();
		long nowdl = nowD.getTime();
		long eta = (nowdl - oridl) / 1000;
		long day;
		long hour;
		long minute;
		day = eta / (24 * 60 * 60);
		...
		minute = eta / 60;
		eta -= minute * 60;
		String as = "" + day + "天" + hour + "小时" + minute + "分钟" + eta + "秒";
		return as;
	}
	 ...
	 * @param def
	 * @return
	 * @author @since：2008-2-15 下午05:01:37
	 */
	 ...
	 * 
	 * @return
	 * @author @since：2008-2-15 下午05:03:13
	 */
	...
	/**
	 * 
	 * Description:格式化日期,Date字符串转化为String
	 * 
	 * @param date
	 * @param dtFormat 例如:yyyy-MM-dd HH:mm:ss yyyyMMdd
	 * @return
	 * @author @since：2007-7-10 上午11:24:00
	 */
	...
	/**
	 * Description:按指定格式 格式化日期 传空默认为年月日时分秒
	 * 
	 * @param date
	 * @param dtFormat
	 * @return
	 * @author @since：2007-12-10 上午11:25:07
	 */
	 ...
	 * @param date
	 * @return
	 * @author @since：2007-12-10 上午11:25:50
	 */
	 ...
	 * @return
	 * @author @since：2007-12-10 上午11:26:12
	 */
	 ...
	 * @param date
	 * @param countMonth
	 * @return @since：2007-12-13 下午03:16:47
	 */
	 ...
	 * @param date
	 * @return
	 * @author @since：2007-12-13 下午02:57:38
	 */
	 ...
	 * @param date
	 * @return
	 * @author @since：2007-12-13 下午03:01:35
	 */
	 ...
	 * @param date1
	 * @return
	 * @author @since：2007-12-13 下午03:28:21
	 */
	 ...
	 * @author @since：2007-12-13 下午03:28:21
	 */
	public static Date getLastDayOfMonthHms(Date date1) {
		Calendar date = Calendar.getInstance();
		date.setTime(date1);
		date.set(Calendar.DAY_OF_MONTH, 1);
		...
		return toLongDate(date.getTime());
	}
	 ...
	 * @param days天数
	 * @return
	 * @author @since：2007-12-17 下午03:47:12
	 */
	...
	/**
	 * 返回一个日期的年份 当传入的参数date为null时，返回-1
	 * 
	 * @param date
	 * @return
	 */
